...
namespace QTCSDLHD.Functions
{
    ...
    public class CassandraDB
    {
        ...
        public List<object> getChiTietChuyenXeKH(string diemden, string diemdi, string ngaydi, string ngayve)
        {
            var result = session.Execute("SELECT * FROM chuyenxe WHERE diemdi = '" + diemdi + "' AND diemden = '" + diemden + "' ALLOW FILTERING;");
            ...
            {
                object MaChuyenXe = row["machuyenxe"].ToString();
                var ChiTietResult = session.Execute("SELECT * FROM chitietchuyenxe WHERE ngaydi = '" + ngaydi + "' AND ngayve = '" + ngayve + "' AND machuyenxe = '" + MaChuyenXe + "' ALLOW FILTERING;");
                ...
                foreach (var chiTietRow in ChiTietResult)
                {
                    chiTietList.Add(new
                    {
                        ...
                        giatien = row["giatien"].ToString(),
                        ngaydi = chiTietRow["ngaydi"].ToString(),
                        ngayve = chiTietRow["ngayve"].ToString(),
                        giodi = chiTietRow["giodi"].ToString(),
                        gioden = chiTietRow["gioden"].ToString(),
                    });
                }
    ...
    public class TimChuyen
    {
        ...
        public List<object> loadListChuyenXeKH(string diemden, string diemdi, string ngaydi, string ngayve)
        {
            return CassandraDB.getChiTietChuyenXeKH(diemden, diemdi, ngaydi, ngayve);
        }
